...
class HospitalsListContainerScreen extends StatelessWidget {
  HospitalsListContainerScreen({Key? key}) : super(key: key);
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<HospitalsListContainerBloc>(
        ...
        child: HospitalsListContainerScreen());
  }

  @override
  Widget build(BuildContext context) {
    mediaQueryData = MediaQuery.of(context);
    return BlocBuilder<HospitalsListContainerBloc, HospitalsListContainerState>(
        builder: (context, state) {
      return SafeArea(
          child: Scaffold(
              body: Navigator(
                  key: navigatorKey,
                  initialRoute: AppRoutes.hospitalsListPage,
