import 'bloc/map_container_bloc.dart';
...
class MapContainerScreen extends StatelessWidget {
  MapContainerScreen({Key? key}) : super(key: key);

  GlobalKey<NavigatorState> navigatorKey = GlobalKey();

  static Widget builder(BuildContext context) {
    return BlocProvider<MapContainerBloc>(
        create: (context) => MapContainerBloc(
            MapContainerState(mapContainerModelObj: MapContainerModel()))
          ..add(MapContainerInitialEvent()),
        child: MapContainerScreen());
  }

  @override
  Widget build(BuildContext context) {
    mediaQueryData = MediaQuery.of(context);
    return BlocBuilder<MapContainerBloc, MapContainerState>(
